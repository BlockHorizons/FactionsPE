...
class Top extends Command {
    ...
    public function perform(CommandSender $sender, $label, array $args) {
        ...
        $pager = new Pager("top-header", $page, $height, $book, $sender, function(array $d, int $i, CommandSender $sender) {
            return Localizer::trans('top-line', [$i+1, $d[0], $d[1]]);
        });
        $pager->stringify();

        $sender->sendMessage(Text::titleize(Localizer::trans($pager->getHeader(), [$pager->getPage(), $pager->getMax()])));
