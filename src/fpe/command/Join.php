...
class Join extends Command
{
    ...
    public function __construct(FactionsPE $plugin, string $name, string $description, string $permission, array $aliases = [])
    {
        ...
        $this->addParameter((new MemberParameter("player", MemberParameter::ONLINE_MEMBER))->setDefaultValue("self")->setPermission("factionspe.join.other")); # todo: correct perm node -> const
    }
